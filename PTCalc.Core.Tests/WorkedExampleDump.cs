...
/// <summary>Geçici araç: rehberdeki işlenmiş örnek için motor çıktısını JSON'a döker (PTCALC_WORKED_OUT verilirse).</summary>
public class WorkedExampleDump
{
    [Fact]
    public void Dump_when_requested()
    {
        var outPath = Environment.GetEnvironmentVariable("PTCALC_WORKED_OUT");
