using PTCalc.Localization;
using PTCalc.Middleware;
using PTCalc.Site;
using PTCalc.Services;
...
// "105.0000" yazardı. İki kültür: tr-TR ve en-US. Varsayılan alan adından gelir (ptcalc.net → en-US,
...
// Eski spps.* adları ptcalc.*'e; yalnız maege.tr'de kalan eski bölümler oraya
...
// crossorigin="use-credentials"> ile dil çerezi de gelir, böylece ptcalc.tr Türkçe,
// ptcalc.net İngilizce açıklamayla kurulur.
app.MapGet("/site.webmanifest", (HttpContext ctx) =>
{
    ...
    {
        id = "/",
        name = en ? "PTCalc · Pharmaceutical technology calculation tools" : "PTCalc · Farmasötik teknoloji hesaplama araçları",
        ...
        icons = new object[]
        {
            new { src = "/img/ptcalc/icon-192.png", sizes = "192x192", type = "image/png" },
            new { src = "/img/ptcalc/icon-512.png", sizes = "512x512", type = "image/png" },
            new { src = "/img/ptcalc/icon-512.png", sizes = "512x512", type = "image/png", purpose = "maskable" }
        }
    };
